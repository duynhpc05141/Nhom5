    ...
    <script>
        $(document).ready(function() {
            $("#commentForm").submit(function(event) {
                ...
                if (commentContent === "" || !isLoggedIn) {
                    event.preventDefault();

                    var message = isLoggedIn ? 'Nội dung bình luận không được trống.' : 'Bạn cần đăng nhập để bình luận';
            ...
            $("#commentForm").validate({
                ...
                messages: {
                    comment_content: {
                        required: "Nội dung bình luận không được trống."
                    }
                },
